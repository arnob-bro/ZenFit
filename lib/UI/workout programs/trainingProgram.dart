...
import 'package:zenfit/UI/workout%20programs/custom/mine.dart';
import 'package:zenfit/UI/workout%20programs/inbuilt/programs.dart';
        ...
        body: ListView(
          children: [
            Card(
              ...
              child: ListTile(
                title: Text("Mine",style: TextStyle(color: Colors.white),),
                onTap: () {
