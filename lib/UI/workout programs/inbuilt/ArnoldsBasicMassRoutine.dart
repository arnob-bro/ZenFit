        ...
        children: [
          Card(
            ...
            child: ListTile(
                ...
                onTap: ()async{
                  await FirebaseFirestore.instance.collection("followedprograms").doc(DatabaseService.user.uid).collection('other').doc("Arnold's Basic Mass Routine - 6 days per week").set(
