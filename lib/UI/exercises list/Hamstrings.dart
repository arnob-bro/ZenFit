...
class Hamstrings extends StatefulWidget {
  ...
  const Hamstrings({super.key, required this.category, required this.programName, required this.weektime, required this.workouttime, required this.workoutName});
                      ...
                      onTap: ()async{
                        ...
                        if(widget.category == "mine"){
                          await FirebaseFirestore.instance
                              ...
                              .set({"time": time,"name": hamstrin[index],"sets": 0,"reps" : 0});
